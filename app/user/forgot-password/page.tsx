    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 xl:w-1/2 flex-col justify-center bg-gradient-to-br from-green-600 via-emerald-600 to-teal-700 p-10 text-white">
        ...
        <p className="text-green-100 text-base leading-relaxed max-w-sm">
          No worries — we&apos;ll send a 6-digit reset code to your registered email address. It only takes a minute.
        </p>
        <div className="mt-10 space-y-3">
          {[
            ...
            <div key={t} className="flex items-center gap-3 text-sm text-green-100">
          ...
          {!sent ? (
            <>
              ...
              <p className="text-sm text-gray-500 mb-8">
                Enter the email address you used to register and we&apos;ll send you a reset code.
              </p>
            ...
            <div className="text-center">
              ...
              <Link
                href={`/user/reset-password?email=${encodeURIComponent(email)}`}
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors"
              >
                Enter Reset Code →
              </Link>
